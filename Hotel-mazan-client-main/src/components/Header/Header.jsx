...
const Header = ({ type }) => {
  const notify = () => toast("Please login to search");
      ...
      <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
        ...
        {type !== "list" && (
          <>
            ...
            Your next adventure begins with a click
            </h1>
            <h1 data-aos="fade-left" className="sticker">Book your stay, unlock the journey !!</h1>
            ...
            <button className="headerBtn" data-aos="fade-left" color="white" ><Link style={{color:'white',textDecoration:'none'}}to="/login">Get started</Link></button>
            {/* hotel search */}
